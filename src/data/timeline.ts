export const timeline = [
  ...
  {
    year: "2019 - 2022",
    title: "Trải nghiệm Giảng dạy & Tham vấn Sơ khởi",
    description: `Thời gian trực tiếp tương tác với nhiều đối tượng người học khác nhau:<br/>
    <ul style="margin-top: 6px; padding-left: 20px; list-style-type: disc; font-size: 0.9em; line-height: 1.6;">
      <li>Giảng dạy kỹ năng sống cho dự án VNHelp; làm <strong>Phó Tổng phụ trách</strong> tại Trường Tiểu học Lê Ngọc Hân.</li>
      <li>Giảng dạy kỹ năng sống tại <strong>Trung tâm Đào tạo Kỹ năng sống Ý Tưởng Việt</strong> và <strong>Trường quốc tế VASchool</strong>.</li>
      <li>Thực hành <strong>sơ cấp cứu tâm lý khẩn cấp</strong> tại dự án Well Being Life và tham vấn viên tại <strong>Phòng Tham vấn tâm lý CTIM</strong>.</li>
    </ul>`
  },
  {
    year: "2022 - Hiện tại",
  ...
  },
  {
    ...
    <ul style="margin-top: 6px; padding-left: 20px; list-style-type: disc; font-size: 0.9em; line-height: 1.6;">
      <li>Theo học <strong>Chương trình Thạc sĩ Ngôn ngữ Anh</strong> tại Trường Đại học Kinh tế - Tài chính TP.HCM (UEF).</li>
      <li>Hoàn thiện chương trình học <strong>Nghiệp vụ sư phạm cấp 2 và cấp 3</strong> để chuẩn bị đứng lớp thực tế.</li>
      <li>Định hướng kết hợp mạnh mẽ: <strong>Tâm lý giáo dục + Ngôn ngữ Anh + Phương pháp giảng dạy + Công nghệ hỗ trợ học tập</strong> để tư vấn lộ trình học phù hợp nhất cho người học.</li>
    </ul>`
  },
  {
    year: "Kế hoạch 5 năm tới & Dài hạn",
    title: "Trở thành Chuyên gia & Giảng viên Tâm lý Giáo dục hiện đại",
    description: `Định hướng phát triển sự nghiệp dài hạn và bền vững:<br/>
    <ul style="margin-top: 6px; padding-left: 20px; list-style-type: disc; font-size: 0.9em; line-height: 1.6;">
      <li><strong>Ngắn hạn:</strong> Tích lũy kinh nghiệm giảng dạy thực tế tại các trung tâm ngoại ngữ, hoàn tất thi biên chế giáo dục trong vòng 1 năm tới.</li>
      <li><strong>Trung hạn:</strong> Kết hợp đi dạy ở trung tâm và xây dựng thương hiệu cá nhân, hướng đến tự mở lớp học thêm độc lập.</li>
      <li><strong>Dài hạn:</strong> Trở thành giảng viên cao cấp, chuyên gia sâu sắc trong ngành tâm lý giáo dục; nghiên cứu sâu về Metacognition (siêu nhận thức) và ứng dụng công nghệ/AI nâng cao trải nghiệm học tập của sinh viên.</li>
    </ul>`
  }
];
